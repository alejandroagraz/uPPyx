...
@section('content')
    <div class="container">
        ...
        @if (session('status'))
            <p class="padding-top-msj msj-{{ Session::get('message_type') }}"><i
                        class="fa fa-check-circle msj-{{ Session::get('message_type') }}"
                        aria-hidden="true"></i> {{ Session::get('status') }}</p>
        @endif
            ...
            <div class="col-md-11">
                ...
                <div class="col-md-4 filter-border">
                    ...
                    <div class="row filter-top">
                        ...
                        <div class="col-md-9 slider-filter">
                            <input id="slider-uppyx-cost" type="text" data-slider-min="1"
                                   data-slider-max="{{$maxTotalCost+1}}"
                                   data-slider-step="1" data-slider-value="[1,{{$maxTotalCost+1}}]"/>
                        </div>
                        <div class="col-md-1">
                            <label class="slider-filter-legend slider-filter-legend-right"
                                   id="label-max-cost">${{$maxTotalCost+1}}</label>
                        </div>
                    </div>
                ...
                <div class="col-md-4 filter-border">
                    <h4 class="filter-title">Agencia / Fechas (Entrega - Devolución)</h4>
                    <select class="form-control select-filter" id="agency_id" name="agency_id">
                        <option value="" selected="selected" disabled>Seleccionar agencia</option>
...
//                    {data: null, defaultContent: "<button class='info-modal btn btn-info'><span class='fa fa-info-circle'></span> Detalles</button>", orderable: false, searchable: false}
                ],
                "columnDefs": [
