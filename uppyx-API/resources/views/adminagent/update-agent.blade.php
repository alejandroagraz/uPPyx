...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active">Actualizar Agente</li>
        </ol>
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="form-group col-md-offset-3 col-md-6">
                    <form class="form-horizontal" method="POST" action="{{ url('/updated-agent') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->rental->has('address') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                <textarea class="form-control text-center" rows="3" maxlength="100" name="address" type="text" placeholder="Dirección">{{$user->address}}</textarea>
