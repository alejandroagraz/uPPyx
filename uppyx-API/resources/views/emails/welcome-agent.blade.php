...
@section('contentMail')
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <div>
                    <p style="text-align: center !important; font-size: 23px; color: #4a4a4a;font-family: 'Open Sans Bold', sans-serif !important; font-weight: bold !important;font-style: normal;font-stretch: normal;">Bienvenido a uPPyx Agente, {{$name}}</p>
